...
/**
 * Ruta para realizar la cuenta de cobro a los propietarios en el a�o actual por concepto de admin - anualmente
 */
...
/**
 * Ruta para realizar la cuenta de cobro a los propietarios en el a�o actual por concepto de parqueadero
 */
Route::post('/propietarios/cobro/parqueadero','PropietarioController@cobroParqueadero');

/**
 * Ruta para realizar la cuenta de cobro a los propietarios en el a�o actual por concepto de otros
 */
